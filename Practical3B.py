...
def newDistance(x1, y1, point1, point2, point3, point4):
    d1 = [x1,y1]
    d1temp = sumOfDistance(x1, y1, point1[0], point1[1], point2[1], point2[0], point3[0], point3[1], point4[0], point4[1])
    d1.append(d1temp)
    return d1

minDistance = sumOfDistance(startingPoint[0], startingPoint[1], point1[0], point1[1], point2[1], point2[0], point3[0], point3[1], point4[0], point4[1])
flag = True
